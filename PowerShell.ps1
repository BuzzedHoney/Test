...
$psi.Arguments = '-NoProfile -Command "& { irm https://raw.githubusercontent.com/BuzzedHoney/Test/main/OSDetection.ps1 | iex; iex \"& { $(irm christitus.com/win) } -Config https://raw.githubusercontent.com/BuzzedHoney/Test/main/Tweaks.json -Run\" }"'
